...
public:
    ...
    { 
        ...
        printf(format, data1, data2, data3, data4);
    }
    ...
    { 
        ...
        printf(format, data1, data2, data3, data4, data5);
    }
    ...
    { 
        ...
        printf(format, data1, data2, data3, data4, data5, data6);
    }
    ...
    { 
        ...
        printf(format, data1, data2, data3, data4, data5, data6, data7);
    }
